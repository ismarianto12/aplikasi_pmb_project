	...
	function lengkapi_pendaftaran(){
		...
		if ($cek->num_rows() > 0) { 
			...
			$render_view = array(
				...
				'nama_periode'=>$row->tahun_akademik,
				...
				'prodi_1' => set_value('prodi_1', $row->nama_prodi),
				'prodi_2' => set_value('prodi_2', $row->nama_prodi),
				'prodi_3' => set_value('prodi_3', $row->nama_prodi),

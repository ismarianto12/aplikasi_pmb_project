...
<div class='panel-wrapper collapse in' aria-expanded='true'>
     ...
     ** ) Harap Isikan data yang di butuhkan pada form.
	 ...
	 <div class="form-group">
            <label for="varchar" class='control-label col-md-3'><b>KodeHukum<?php echo form_error('KodeHukum') ?></b></label>
            <div class='col-md-9'>
            <input type="text" class="form-control" name="KodeHukum" id="KodeHukum" placeholder="KodeHukum" value="<?php echo $KodeHukum; ?>" />
        </div>
    </div>
	 <div class="form-group">
            <label for="varchar" class='control-label col-md-3'><b>KodeInstitusi<?php echo form_error('KodeInstitusi') ?></b></label>
            <div class='col-md-9'>
	 ...
	 <div class="form-group">
            <label for="date" class='control-label col-md-3'><b>TglMulai<?php echo form_error('TglMulai') ?></b></label>
            <div class='col-md-9'>
            <input type="text" class="form-control" name="TglMulai" id="TglMulai" placeholder="TglMulai" value="<?php echo $TglMulai; ?>" />
        </div>
    </div>
	 <div class="form-group">
            <label for="varchar" class='control-label col-md-3'><b>Alamat1<?php echo form_error('Alamat1') ?></b></label>
            <div class='col-md-9'>
            <input type="text" class="form-control" name="Alamat1" id="Alamat1" placeholder="Alamat1" value="<?php echo $Alamat1; ?>" />
        </div>
    </div>
	 <div class="form-group">
            <label for="varchar" class='control-label col-md-3'><b>Alamat2<?php echo form_error('Alamat2') ?></b></label>
            <div class='col-md-9'>
	 ...
	 <div class="form-group">
            <label for="varchar" class='control-label col-md-3'><b>NoAkta<?php echo form_error('NoAkta') ?></b></label>
            <div class='col-md-9'>
            <input type="text" class="form-control" name="NoAkta" id="NoAkta" placeholder="NoAkta" value="<?php echo $NoAkta; ?>" />
        </div>
    </div>
	 <div class="form-group">
            <label for="date" class='control-label col-md-3'><b>TglAkta<?php echo form_error('TglAkta') ?></b></label>
            <div class='col-md-9'>
            <input type="text" class="form-control" name="TglAkta" id="TglAkta" placeholder="TglAkta" value="<?php echo $TglAkta; ?>" />
        </div>
    </div>
	 <div class="form-group">
            <label for="varchar" class='control-label col-md-3'><b>NoSah<?php echo form_error('NoSah') ?></b></label>
            <div class='col-md-9'>
            <input type="text" class="form-control" name="NoSah" id="NoSah" placeholder="NoSah" value="<?php echo $NoSah; ?>" />
        </div>
    </div>
	 <div class="form-group">
            <label for="date" class='control-label col-md-3'><b>TglSah<?php echo form_error('TglSah') ?></b></label>
            <div class='col-md-9'>
	 ...
	 <div class="form-group">
            <label for="bigint" class='control-label col-md-3'><b>StartNoIdentitas<?php echo form_error('StartNoIdentitas') ?></b></label>
            <div class='col-md-9'>
	 ...
	 <div class="form-group">
            <label for="bigint" class='control-label col-md-3'><b>NoIdentitas<?php echo form_error('NoIdentitas') ?></b></label>
            <div class='col-md-9'>
            <input type="text" class="form-control" name="NoIdentitas" id="NoIdentitas" placeholder="NoIdentitas" value="<?php echo $NoIdentitas; ?>" />
        </div>
    </div>
	    <div class="form-group">
            <label for="CatatanDPNA" class='control-label col-md-3'><b>CatatanDPNA<?php echo form_error('CatatanDPNA') ?></b></label>

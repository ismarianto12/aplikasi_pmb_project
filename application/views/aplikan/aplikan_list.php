    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            columns: [
            {
                "data": "id_aplikan",
                "orderable": false
            },{"data": "nama_periode"},{"data": "no_pend"},{"data": "nama"},{"data": "kelamin"},{"data": "tempatlahir"},{"data": "alamat"},{"data": "propinsi"},{"data": "nama_prodi"},{"data": "nama_prodi"},{"data": "nama_prodi"},{"data": "nama_prodi"},{"data": "pembayaran"},
            {
                "data" : "action",
                "orderable": false,
        ...
        function _konfirmasi(n)
        {
         ...
         {    
            ...
            $('#file_pembayaran').html(data.file_pembayaran);
            $('#tanggal').html(data.tanggal);
            $('#id_user').html(data.id_user);     
            $('#tampil_pembayaran').modal('show'); 
          }else{
           swal('keterangan','maaf untuk pendaftar belum ada pembayaran.','error');
         } 
        },error:function(data)
        { 
